...
class ProductRepositoryTest {
    ...
    @BeforeEach // 테스트 돌리기 전에 실행, 데이터를 미리 넣고 돌린다.
    ...
    void testFindAll(){
        ...
        //then
        products.forEach(System.out::println); // 실무는 다 assert로 확인함
    ...
    void testFindOne(){
        ...
        Long id = 3L;
        //when
        Optional<Product> product   // JAVA null체크의 불편함, nullPointerException
